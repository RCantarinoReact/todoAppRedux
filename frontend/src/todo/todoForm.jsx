...
import { add, changeDescription, search , clear } from '../actionCreators/todo.actions'
...
class TodoForm extends Component {
    ...
    //metodo que sera chamado ANTES do componente ser montado
    //Os objetos devem ser preenchidos neste componente
    componentWillMount(){
        this.props.search()
    }
